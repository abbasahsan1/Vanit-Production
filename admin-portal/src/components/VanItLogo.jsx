...
/**
 * Centralized Logo Component for Admin Portal
...
const VanItLogo = ({ 
  ...
  const [currentSrc, setCurrentSrc] = useState(variant === "primary" ? "/admin/2.png" : "/admin/1.png");

  const handleImageError = () => {
    if (!imageError) {
      setImageError(true);
      // Try the alternate logo if primary fails
      setCurrentSrc(variant === "primary" ? "/admin/1.png" : "/admin/2.png");
    }
  };
